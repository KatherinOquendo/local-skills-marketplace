...
1. **El poder informal supera al formal.** Los organigramas muestran quién debería decidir; el mapeo revela quién realmente decide. Siempre investiga ambos. [EXPLICIT]
2. **El silencio es la señal más peligrosa.** Un stakeholder que no responde no es un stakeholder alineado — es un riesgo no cuantificado que requiere acción inmediata. [EXPLICIT]
3. **El mapa es un organismo vivo.** Las dinámicas de poder cambian con cada sprint, cada reorganización, cada éxito y cada fracaso. Un mapa estático es un mapa mentiroso. [EXPLICIT]
...
- `{MODO}`: `piloto-auto` (default) | `desatendido` | `supervisado` | `paso-a-paso`
  ...
  - **desatendido**: Cero interrupciones. Stakeholders inferidos de documentación disponible. Supuestos documentados. [EXPLICIT]
  - **supervisado**: Autónomo con reportes en milestones. Preguntas solo en conflictos de poder o ambigüedad de RACI. [EXPLICIT]
  - **paso-a-paso**: Confirma antes de cada categorización, asignación RACI y estrategia de engagement. [EXPLICIT]
