# Domain Knowledge — project program management

## Overview

This reference provides foundational knowledge for the project program management skill. [EXPLICIT]

## Key Concepts

| Concept | Definition | Relevance |
|---------|-----------|-----------|
| Primary domain | The core domain that project program management operates within | Direct input to skill execution [EXPLICIT] |
